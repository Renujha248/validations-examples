...
const Dashbord = () => {
    return (
        <div>
            <div className='font-bold text-3xl p-4 border border-y-8 text-center text-gray-500'>Dashboard</div>
            <div className='container grid grid-cols-4 bg-gray-300'>
                <div className='col-span-4 text-center'>
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-24 mx-auto">
                            <div class="flex flex-col text-center w-full mb-20">
                                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-pink-800">Renu's Component Code</h1>
